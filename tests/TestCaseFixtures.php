...
class TestCaseFixtures extends TestCase
{
    ...
    protected function getLastBuildMode(): ?string
    {
     ...
     */
    protected function readAllRuntimeConfigs():void
    {
     ...
     * @return string
     */
    protected function getBuiltDsn(): ?string
    {
     ...
     * @return string
     */
    protected function getConnectionDsn(string $database = 'bookstore', bool $withCredentials = false): string
    {
     ...
     * @return string
     */
    protected function getFixturesConnectionDsn(): string
    {
    ...
    protected function getDriver(): string
    {
        ...
        return '' !== $db ? $db : strtolower($driver);
    }
}
