...
class BehaviorManager
{
     ...
     */
    public function setGeneratorConfig(GeneratorConfigInterface $config = null): void
    {
     ...
     * @throws JsonException If something goes wrong while decoding `composer.json` file
     */
    public function getBehaviors(): array
    {
        if (null === $this->behaviors) {
            ...
            if (null !== $json) {
                $behavior = $this->loadBehavior(Json::decode($json->getContents(), true));
     ...
     */
    private function loadBehaviors(SplFileInfo $composerLock): array
    {
        $behaviors = [];
