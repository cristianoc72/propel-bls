...
";
     ...
     * @author     Niklas Närhinen <niklas@narhinen.net>
     * @return string
     * @see SqlDefaultPlatform::getModifyColumnDDL
     */
...
",
   ...
   USING CASE WHEN trim($name) SIMILAR TO '[0-9]+'
     ...
     * @author     Niklas Närhinen <niklas@narhinen.net>
     * @return string
     * @see SqlDefaultPlatform::getModifyColumnsDDL
     */
     ...
     * @author     Niklas Närhinen <niklas@narhinen.net>
     * @return string
     * @see SqlDefaultPlatform::getAddColumnsDLL
     */
     ...
     * @author     Niklas Närhinen <niklas@narhinen.net>
     * @return string
     * @see SqlDefaultPlatform::getDropIndexDDL
     */
